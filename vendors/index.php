...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron container mt-3">
        <a href="add.php" class="btn btn-danger">Add Post <i class="fas fa-plus"></i></a>
        <h1 class="display-4">Latest Post</h1>
        <div class="row mt-3">
            <div class="col-md-4 mb-3">
                <div class="card" style="width: 18rem;">
                    <img src="default-product.png" class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title">Post's Title</h5>
                        <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ducimus, adipisci ea. Reprehenderit sit molestias libero placeat beatae, quasi numquam culpa ...</p>
                        <a href="details.php" class="btn btn-danger">Read More</a>
                    </div>
                </div>
            </div>
        </div>
